...
const Home = () => {
    ...
    if (step === Step.FRAME) {
        return <FrameHome onSelect={(val) => setFrameInput(val)} setStep={setStep} Step={Step} frameInput={frameInput} frames={frames} />;
    }
                        ...
                        {quoteResponse && (
                            <div className="grid grid-cols-12 gap-5">
                                <div className="col-span-8">
                                    ...
                                    <Image src={quoteResponse?.quote?.preview?.downloadURL} width={400} height={400} alt="Preview" />
                                </div>
